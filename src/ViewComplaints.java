...
public class ViewComplaints extends javax.swing.JFrame {
    ...
    String issue,status,uid;
    
    public ViewComplaints(String iss, String st,String username) {
        initComponents();
                ...
                while(stt.hasMoreTokens()){
                    ...
                    obj.vdbtn.addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent evt) {
                            ViewComplaints.this.dispose();
                            new ViewDetails(a,b,c,d,e,f,g,h,i,j,k,uid).setVisible(true);
                    }
                });
                }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(80, 130, 1120, 520);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HRViewComplaints.jpg"))); // NOI18N
