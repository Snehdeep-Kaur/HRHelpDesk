...
public class HRLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        usertf.setBounds(490, 320, 290, 40);
        getContentPane().add(passpf);
        passpf.setBounds(490, 470, 290, 40);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HRLogin.jpg"))); // NOI18N
        ...
        submitlb.setBounds(520, 560, 250, 60);
        ...
        backlb.setBounds(1130, 650, 120, 60);
