...
public class ChangePassword extends javax.swing.JFrame {
    ...
    public ChangePassword(String usd) {
        initComponents();
        userid=usd;
    ...
    private void initComponents() {
        ...
        backlb.setBounds(1120, 690, 150, 30);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ChangePasswordUser.jpg"))); // NOI18N
