...
public class ViewDetails extends javax.swing.JFrame {
    ...
    String gcid, geid, gename, gphn, gemail, gdept, giss, gbody, gst, gcdate, gladate,uid;
    public ViewDetails(String cid, String eid, String ename, String phn, String email, String dept, String iss, String body, String st, String cdate, String ladate, String username) {
        initComponents();
        gcid = cid;
        geid = eid;
        gename = ename;
    ...
    private void initComponents() {
        ...
        eidtf.setBounds(250, 120, 190, 40);
        ...
        deptf.setBounds(290, 200, 210, 40);
        ...
        responselbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HRViewDetails.jpg"))); // NOI18N
        responselbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                responselblMouseClicked(evt);
            }
        });
        getContentPane().add(responselbl);
        responselbl.setBounds(0, 0, 1280, 720);

        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(330, 660, 210, 40);
    ...
    private void responselblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_responselblMouseClicked
        new WriteResponse(gcid,geid,gcdate,gladate,gst,giss,uid).setVisible(true);
        this.dispose();
    }//GEN-LAST:event_responselblMouseClicked
